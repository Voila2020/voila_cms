...
return [
    ...
    'default_image' => 'هذه الصورة سوف تظهر في حال كان الحقل الخاص بالصورة فارغا',
    'def_img_quality'  => 'هذا الحقل يحدد جودة الصورة بعد الرفع(سوف تنقص جودة الصورة كلما قللنا القيمة المدخلة وبالعكس) القيمة من 0 الى 100',
    'notifications_activity' => 'هذا الحقل يحدد اذا كانت الاشعارات مفعلة ام لا (غير مفعلة افتراضيا)',
