...
return [
    ...
    'def_img_quality' => 'هذا الحقل يحدد جودة الصورة بعد الرفع(سوف تنقص جودة الصورة كلما قللنا القيمة المدخلة وبالعكس)',
    'This field specifies the quality of the image after uploading(The image quality will decrease as we decrease the input value and vice versa)'  => 'هذا الحقل يحدد جودة الصورة بعد الرفع(سوف تنقص جودة الصورة كلما قللنا القيمة المدخلة وبالعكس)',
    'This field determines whether notifications are enabled or not (not enabled by default)' => 'هذا الحقل يحدد اذا كانت الاشعارات مفعلة ام لا (غير مفعلة افتراضيا)',
