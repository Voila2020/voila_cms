...
return [
    ...
    'activate_label' => ' تفعيل الحقل :field_name',
    'deactivate_label' => 'الغاء تفعيل الحقل :field_name',
    'has_images' => 'يحوي صور ؟',
    'model_images' => 'الصور',
    ...
    'create_ticket'=>'إضافة تذكرة',
    'description'=>'التوصيف',
    'attachment'=>'المرفق',
    'send_ticket'=>'إرسال التذكرة',
    'all_tickets'=>'كل التذاكر',
    'ticket_added_successfully'=>'تم إضافة التذكرة بنجاح',
    'ticket_added_failed'=>'فشل بإضافة التذكرة. حاول مرة أخرى.',
    'my_tickets'=>'تذاكري',
    'contact_support_instruction'=>'لتواصل مع فريق الدعم. استخدم هذا القسم لإضافة تذكرة',
    'important_note'=>'ملاحظة مهمة:',
    'ticket_table_note'=>'الجدول أدناه يعرض أحدث التذاكر المفتوحة.',
    'single_ticket_reply_instruction'=>'نرجو منكم متابعة تعليقاتكم بخصوص أي قضية ضمن تذكرة واحدة فقط، وذلك لتنظيم المراسلات بشكل أفضل. شكرًا لتفهمكم.',
    'continue_existing_ticket'=>'لمتابعة تذكرة مفتوحة مسبقًا، اضغط على زر عرض في الجدول أدناه.',
    ...
    'status_new'=>'جديدة',
    'status_in_progress'=>'يتم العمل عليها',
    'status_closed'=>'مغلقة',
    'no_tickets_yet'=>'لا تذاكر حتى الآن',
    'view'=>'مشاهدة',
