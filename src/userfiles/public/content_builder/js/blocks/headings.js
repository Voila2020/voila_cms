...
editor.BlockManager.add("heading1", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/heading1.svg" alt=""><div class="draggable"></div><br> Heading1',
    content: `<div>
      <div class="container">
...
editor.BlockManager.add("heading2", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/heading2.svg" alt=""><div class="draggable"></div><br> Heading2',
    content: `
