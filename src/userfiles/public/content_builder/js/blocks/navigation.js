function navigation_blocks(editor) {
    editor.BlockManager.add("basic-nav", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/basic_nav1.svg" alt=""><div class="draggable"></div><br> Baisc nav',
    ...
    editor.BlockManager.add("fixed-nav", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/basic_nav1.svg" alt=""><div class="draggable"></div><br> Fixed Nav',
    ...
    editor.BlockManager.add("nav_ltr", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/nav_2_logos.svg" alt=""><div class="draggable"></div><br> Navigation 2 Logos',
        content: `<nav class="navbar navbar-expand-md" aria-label="Fourth navbar example">
    <div class="container">
    ...
    editor.BlockManager.add("nav3_ltr", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/logos3.svg" alt=""><div class="draggable"></div><br> Navigation 3 Logos',
        content: `<nav class="navbar navbar-expand-md" aria-label="Fourth navbar example">
<div class="container">
    ...
    editor.BlockManager.add("nav_rtl", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/nav_2_logos.svg" alt=""><div class="draggable"></div><br> Navigation 2 Logos (Arabic)',
        content: `<nav class="navbar navbar-expand-md" aria-label="Fourth navbar example">
    <div class="container">
    <div class="col">
       <img src="${$_SITE}/images/logo.png" width="200" height="50" />
    ...
    editor.BlockManager.add("nav2_ltr", {
        ...
        label:
            '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/nav_logo_contact.svg" alt=""><div class="draggable"></div><br> Navigation with Contact',
        content: ` <nav class="navbar navbar-expand-md " aria-label="Fourth navbar example">
    <div class="container">
