...
editor.BlockManager.add("feature-image", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/feature_image.svg" alt=""><div class="draggable"></div><br> Feature with Image',
    content: `  <div>
    <div class="container">
...
editor.BlockManager.add("feature-image1", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/feature_image_r.svg" alt=""><div class="draggable"></div><br> Feature with Image (Reverse)',
    content: ` <div>
    <div class="container">
        <div class="row flex-lg-row-reverse center-all text-center">
            <div class="col-lg-6 center-all text-center flex-direction-column">
...
editor.BlockManager.add("feature-3-images", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/3_features_img.svg" alt=""><div class="draggable"></div><br> 3 Feature (Images)',
    content: `<style>
    .feature-icon {
        display: inline-flex;
        align-items: center;
...
editor.BlockManager.add("feature-cards", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/features_cards.svg" alt=""><div class="draggable"></div><br> Features Cards',
    content: `<div>
    <div class="container">
...
editor.BlockManager.add("section1", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/icons_titles.svg" alt=""><div class="draggable"></div><br> 3 Icons with Title',
    content: `<div>
    <div class="container">
...
editor.BlockManager.add("featureVideo", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/video.svg" alt=""><div class="draggable"></div><br> Video with Text',
...
editor.BlockManager.add("iconsWithImg", {
    ...
    label:
        '<embed  src="' +
        $_SITE +
        '/content_builder/blocks/images/icons_with_link.svg" alt=""><div class="draggable"></div><br> Image with Icons',
    content: `<section>
      <div class="container">
          <div class="row">
