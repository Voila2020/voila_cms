function footers_blocks(editor) {
    editor.BlockManager.add("footer1", {
        ...
        label: '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/footer.svg" alt=""><div class="draggable"></div><br> Footer1',
        content: ` <div>
    <div class="container">
    ...
    editor.BlockManager.add("footer2", {
        ...
        label: '<embed  src="' +
            $_SITE +
            '/content_builder/blocks/images/footer.svg" alt=""><div class="draggable"></div><br> Footer2',
