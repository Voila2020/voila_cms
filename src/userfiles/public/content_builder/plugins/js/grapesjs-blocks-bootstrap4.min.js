...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["grapesjs-blocks-bootstrap4"] = t(require("grapesjs")))
    : (e["grapesjs-blocks-bootstrap4"] = t(e.grapesjs));
})(self, function (e) {
  return (() => {
    "use strict";
    var t = {
    ...
    return (
      (() => {
          ...
          r = function (e) {
              ...
              onEvent: function (e) {
                ...
                for (
                  var t = e.component,
                    a =
                      (e.event,
                      this.model.get("options").map(function (e) {
                        return e.value;
                      })),
                    n = 0;
                  n < a.length;
                  ...
                  if (a[n].length > 0)
                    for (var o = a[n].split(" "), r = 0; r < o.length; r++)
                      o[r].length > 0 && t.removeClass(o[r]);
                var i = this.model.get("value");
                if (
                  (delete t.attributes.attributes[""],
                  i.length > 0 && "GJS_NO_CLASS" !== i)
                )
                  for (var l = i.split(" "), s = 0; s < l.length; s++)
                    t.addClass(l[s]);
            ...
            t.addType("content", {
              ...
              getInputEl: function () {
                return (
                  this.inputEl ||
                    ((this.inputEl = a.prototype.getInputEl.bind(this)()),
            ...
            model: n.extend(
              ...
              },
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("dropdown"))
            ...
            model: n.extend(
              {
                ...
                init2: function () {
                  this.append({
                    ...
                    this.append({ type: "dropdown_menu" })[0];
                  this.setupToggle(null, null, { force: !0 });
                  var e = this.components();
                  e.bind("add", this.setupToggle.bind(this)),
                    e.bind("remove", this.setupToggle.bind(this));
                  var t = this.get("classes");
                  t.bind("add", this.setupToggle.bind(this)),
                    t.bind("change", this.setupToggle.bind(this)),
                    t.bind("remove", this.setupToggle.bind(this));
                },
                setupToggle: function (e, t) {
                  ...
                  if ((!0 === a.force || !0 !== a.ignore) && n && o) {
                    r(n) ||
                      this.listenTo(n, "change:attributes", this.setupToggle),
                      r(o) ||
                        this.listenTo(o, "change:attributes", this.setupToggle);
                    var i = n.getAttributes();
                    i.role = "button";
                    var l = o.getAttributes();
                    i.hasOwnProperty("data-toggle") ||
                      (i["data-toggle"] = "dropdown"),
                      i.hasOwnProperty("aria-haspopup") ||
                        (i["aria-haspopup"] = !0),
                      n.set("attributes", i, { ignore: !0 }),
                      i.hasOwnProperty("id")
                        ? (l["aria-labelledby"] = i.id)
                        : delete l["aria-labelledby"],
                      o.set("attributes", l, { ignore: !0 });
                  }
                },
                updated: function (e, t) {
                  if (t.hasOwnProperty("initial_state")) {
                    var a = this.components().filter(function (e) {
                      ...
                      n = a.getAttributes();
                    n.class.split(" ").includes("show")
                      ? ((n["aria-expanded"] = !1), a.removeClass("show"))
                      : ((n["aria-expanded"] = !0), a.addClass("show"));
                  }
                },
              },
              {
        ...
        const y = {
          ...
          tabName: v,
          tabPaneName: h,
          navigationSelector: '[data-gjs-type="'.concat(b, '"]'),
          tabPanesSelector: '[data-gjs-type="'.concat(g, '"]'),
          tabSelector: '[data-gjs-type="'.concat(v, '"]'),
          tabPaneSelector: '[data-gjs-type="'.concat(h, '"]'),
          containerId: "data-".concat(f),
          navigationId: "data-".concat(b),
          tabPanesId: "data-".concat(g),
          tabId: "data-".concat(v),
          tabPaneId: "data-".concat(h),
        };
        var w = function (e, t) {
            var a = e.className;
            if ((a = a && a.toString()) && a.split(" ").indexOf(t) >= 0)
              return 1;
          },
          O = function (e) {
            return e
          ...
          e.add("tabs", {
            ...
            e.add("tabs-tab", {
              label: "\n            "
                ...
                .concat(t.labels.tab, "</div>\n        "),
              category: "Components",
              content: { type: "tabs-tab" },
            }),
            e.add("tabs-tab-pane", {
              label: "\n            "
                .concat(j, "\n            <div>")
                .concat(t.labels.tabPane, "</div>\n        "),
              category: "Components",
              content: { type: "tabs-tab-pane" },
            });
        };
        const P = function (e) {
          var t =
            ...
            model: n.extend(
              {
                ...
                init: function () {
                  this.get("classes").pluck("name").indexOf(l) < 0 &&
                    this.addClass(l);
                },
              },
              {
                isComponent: function (e) {
                  if (w(e, l)) return { type: s };
                },
              }
            ),
            view: o.extend({
        ...
        const A = function (e) {
          ...
          e.addType(s, {
            model: n.extend(
              {
                defaults: M(
                  M({}, n.prototype.defaults),
                  {},
                  { name: "Tab", tagName: "li", copyable: !0, draggable: i }
                ),
                init: function () {
                  this.get("classes").pluck("name").indexOf(l) < 0 &&
                    this.addClass(l);
        ...
        const Z = function (e, t) {
          var a,
            ...
            r = o.model,
            i = o.view;
          n.formPredefinedActions && n.formPredefinedActions.length
            ? ((a = {
                type: "select",
              ...
              n.formPredefinedActions.forEach(function (e) {
                a.options.push({ value: e.value, name: e.name });
              }))
            : (a = { label: n.labels.trait_action, name: "action" }),
            e.addType("form", {
              model: r.extend(
                {
                  defaults: V(
                    V({}, r.prototype.defaults),
                    {},
                    {
                      droppable: ":not(form)",
                      draggable: ":not(form)",
                  ...
                  {},
                  {
                    ...
                    traits: [
                      ...
                      t.placeholder,
                      {
                        ...
                        name: "type",
                        options: [
                          { value: "text", name: a.labels.type_text },
                          { value: "email", name: a.labels.type_email },
                          { value: "password", name: a.labels.type_password },
                          { value: "number", name: a.labels.type_number },
                          { value: "date", name: a.labels.type_date },
                          { value: "hidden", name: a.labels.type_hidden },
                        ],
                      },
                      t.required,
                    ],
              ...
              },
              {
                isComponent: function (e) {
                  if (
                    e &&
                    e.classList &&
                    e.classList.contains("form_group_input")
                  )
        ...
        var oe = function (e, t) {
          e.add("textarea", {
            ...
            category: "Forms",
            content:
              '<textarea name="textarea1" class="form-control"></textarea>',
          });
        };
        ...
        var ce = function (e, t) {
          e.add("select", {
            ...
            content: '<select class="form-control" name="select1">\n        '
              .concat(
                t ? '<option value="">'.concat(t, "</option>") : "",
                '\n        <option value="1">'
              )
              .concat(t, " 1</option>\n        </select>"),
          });
        };
        const de = function (e, t, a) {
          var n =
            ...
            model: r.extend(
              {
                defaults: le(
                  ...
                  {},
                  {
                    ...
                    traits: [
                      a.name,
                      { label: n.labels.trait_options, type: "select-options" },
                      a.required,
                    ],
                  }
                ),
          ...
          c.addType("select-options", {
            ...
            onValueChange: function () {
              for (
                var e = this.model.get("value").trim().split("\n"),
                  t = [],
                  a = 0;
                a < e.length;
                a++
                ...
                var o = e[a].split(n.optionsStringSeparator),
                  r = { tagName: "option", attributes: {} };
                o[1]
                  ? ((r.content = o[1]), (r.attributes.value = o[0]))
                  : ((r.content = o[0]), (r.attributes.value = o[0])),
                  t.push(r);
              }
            ...
            getInputEl: function () {
              if (!this.$input) {
                for (
                  var e = "", t = this.target.get("components"), a = 0;
                  a < t.length;
                  a++
                ) {
                  var o = t.models[a],
                  ...
                  e += ""
                    .concat(r)
                    .concat(n.optionsStringSeparator)
            ...
            model: o.extend(
              {
                ...
                handleChecked: function () {
                  var e = this.get("checked"),
                    ...
                    a = this.view;
                  e ? (t.checked = !0) : delete t.checked,
                    a && (a.el.checked = e),
                    this.set("attributes", ue({}, t));
                },
              },
              {
                isComponent: function (e) {
            ...
            model: a.extend(
              {
                defaults: Object.assign({}, a.prototype.defaults, {
                  ...
                  traits: [
                    {
                      type: "class_select",
                      options: [{ value: "", name: "Default" }].concat(
                        xe(
                          Object.keys(Oe).map(function (e) {
                            return { value: "btn-group-" + e, name: Oe[e] };
                          })
                        )
                      ),
                      label: "Size",
              ...
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("btn-group"))
        ...
        const _e = function (e) {
          ...
          e.addType("button_toolbar", {
            model: a.extend(
              ...
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("btn-toolbar"))
        ...
        var Ee = function (e, t) {
          e.add("link", {
            label: "\n            "
              ...
              .concat(t, "</div>\n        "),
            category: "Basic",
            content: { type: "link", content: "Link text" },
          });
        };
        const Ae = function (e) {
          var t = e.DomComponents,
                ...
                setupToggle: function (e, t) {
                  ...
                  if (!0 !== a.ignore || !0 === a.force) {
                    ...
                    if (
                      ...
                      delete n["aria-expanded"],
                      delete n["aria-controls"],
                      delete n["aria-haspopup"],
                      o && o.length > 0 && o.match(/^#/))
                    ) {
                      ...
                      if (r.length > 0) {
                        ...
                        if (s) {
                          ...
                          if (p.length) {
                            ...
                            (n["aria-expanded"] = c.includes("show")),
                              "collapse" === p[0] &&
                                (n["aria-controls"] = o.substring(1));
                          }
                        }
                      }
                    }
                    this.set("attributes", n, { ignore: !0 });
                  }
                },
                classesChanged: function (e) {
                  console.log("classes changed"),
                    "link" === this.attributes.type &&
                      this.attributes.classes.filter(function (e) {
                        return "btn" === e.id;
                      }).length > 0 &&
        ...
        const Fe = function (e, t) {
          ...
          e.addType(i, {
            model: o.extend(
              ...
              {
                isComponent: function (e) {
                  if ("INPUT" === e.tagName && w(e, "form-control-file"))
                    return { type: i };
                },
              }
            ),
            ...
            model: a.extend(
              {
                defaults: Object.assign({}, a.prototype.defaults, {
                  ...
                  classes: ["img-fluid"],
                  traits: [
                    { type: "text", label: "Source (URL)", name: "src" },
                    { type: "text", label: "Alternate text", name: "alt" },
                  ].concat(a.prototype.defaults.traits),
                }),
              },
              {
                isComponent: function (e) {
                  if (e && "IMG" === e.tagName) return { type: o };
                },
              }
            ),
            view: n,
          ...
          Ue = function (e) {
            ...
            e.addType(o, {
              model: a.extend(
                ...
                {
                  isComponent: function (e) {
                    if (e && "embed-responsive" === e.className)
                      return { type: o };
                  },
                }
              ),
              view: n.extend({
                init: function () {
                  ...
                  t.length ||
                    t.add(
                      '<iframe class="embed-responsive-item" src="'.concat(
        ...
        var We = function (e, t) {
          e.add("header", {
            label: "\n            "
              ...
              .concat(t, "</div>\n        "),
            category: "Typography",
            content: { type: "header", content: "Bootstrap heading" },
          });
        };
        const Xe = function (e) {
            var t = e.getType("text"),
        ...
        var Ye = function (e, t) {
          e.add("card", {
            ...
            e.add("card_container", {
              label: "\n            "
                .concat(Je, "\n            <div>")
                .concat(t.labels.card_container, "</div>\n        "),
              category: "Components",
              content: { type: "card_container" },
            });
        };
            ...
            e.addType("card", {
              model: n.extend(
                {
                  ...
                  init2: function () {
                    this.listenTo(
                      ...
                      this.set("card-img-top", !0),
                      this.set("card-body", !0);
                  },
                  ...
                  },
                  {
                    isComponent: function (e) {
                      if (
                        e &&
                        e.classList &&
                        e.classList.contains("card-img-top")
                      )
                  ...
                  },
                  {
                    isComponent: function (e) {
                      if (
                        e &&
                        e.classList &&
                        e.classList.contains("card-header")
                      )
              ...
              e.addType("card_image", {
                model: i.extend(
                  ...
                  {
                    isComponent: function (e) {
                      if (e && e.classList && e.classList.contains("card-img"))
                  ...
                  },
                  {
                    isComponent: function (e) {
                      if (
                        e &&
                        e.classList &&
                        e.classList.contains("card-img-overlay")
                      )
              ...
              e.addType("card_body", {
                model: n.extend(
                  ...
                  {
                    isComponent: function (e) {
                      if (e && e.classList && e.classList.contains("card-body"))
                  ...
                  },
                  {
                    isComponent: function (e) {
                      if (
                        e &&
                        e.classList &&
                        e.classList.contains("card-footer")
                      )
                  ...
                  },
                  {
                    isComponent: function (e) {
                      if (
                        e &&
                        e.classList &&
                        e.classList.contains("card-img-bottom")
                      )
        ...
        var at = function (e, t) {
          e.add("badge", {
            label: "\n            "
              ...
              .concat(t, "</div>\n        "),
            category: "Components",
            content: { type: "badge", content: "New!" },
          });
        };
        const nt = function (e) {
          var t = e.getType("text"),
          ...
          e.addType("badge", {
            model: a.extend(
              ...
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("badge"))
                    return { type: "badge" };
                },
              }
            ),
        ...
        const lt = function (e) {
            ...
            e.addType("alert", {
              model: a.extend(
                ...
                {
                  isComponent: function (e) {
                    if (e && e.classList && e.classList.contains("alert"))
                      return { type: "alert" };
                  },
                }
              ),
        ...
        const dt = function (e) {
          ...
          e.addType("media_object", {
            model: a.extend(
              ...
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("media"))
                    return { type: "media" };
                },
              }
            ),
            ...
            e.addType("media_body", {
              model: a.extend(
                ...
                {
                  isComponent: function (e) {
                    if (e && e.classList && e.classList.contains("media-body"))
        ...
        const ut = function (e) {
          ...
          e.addType("column_break", {
            model: a.extend(
              ...
              {
                isComponent: function (e) {
                  if (e && e.classList && e.classList.contains("w-100"))
        ...
        var vt = function (e, t) {
          e.add("column").set({
            label: "\n            "
              ...
              .concat(t, "</div>\n        "),
            category: "Layout",
            content: { type: "column", classes: ["col"] },
          });
        };
                    ...
                    updateTarget: function (e, a, n) {
                      ...
                      if (o) {
                        ...
                        r >= 1200
                          ...
                          ? (i = "md")
                          : r >= 576 && (i = "sm");
                        var l = 0.5 * (e.parentElement.offsetWidth / 12),
                        ...
                        if (s || c) {
                          ...
                          if (!p)
                            for (
                              var w = 0, O = ["", "xs", "sm", "md", "lg", "xl"];
                              w < O.length;
                              w++
                            ) {
                              var j = O[w];
                              if ((u[j] && ((m = u[j]), (p = !0)), j === i))
                                break;
                            }
                          var x = Number(m);
                          ...
                          i || (C = "col-" + x),
                            o.addClass(C),
                            f && f !== C && o.removeClass(f),
                            o
                              .getTrait((i || "xs") + "_width")
                              .view.postUpdate();
                        }
                      }
                    },
                  ...
                  traits: [
                    ...
                    },
                    {
                      ...
                      options: [
                        ...
                        mt(
                          r.map(function (e) {
                            return { value: "col-sm-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "SM Width",
                    },
                    {
                      ...
                      options: [
                        ...
                        mt(
                          r.map(function (e) {
                            return { value: "col-md-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "MD Width",
                    },
                    {
                      ...
                      options: [
                        ...
                        mt(
                          r.map(function (e) {
                            return { value: "col-lg-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "LG Width",
                    },
                    {
                      ...
                      options: [
                        ...
                        mt(
                          r.map(function (e) {
                            return { value: "col-xl-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "XL Width",
                    },
                    {
                      ...
                      options: [{ value: "", name: "None" }].concat(
                        mt(
                          r.map(function (e) {
                            return { value: "offset-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "XS Offset",
                    },
                    {
                      ...
                      options: [{ value: "", name: "None" }].concat(
                        mt(
                          r.map(function (e) {
                            return { value: "offset-sm-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "SM Offset",
                    },
                    {
                      ...
                      options: [{ value: "", name: "None" }].concat(
                        mt(
                          r.map(function (e) {
                            return { value: "offset-md-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "MD Offset",
                    },
                    {
                      ...
                      options: [{ value: "", name: "None" }].concat(
                        mt(
                          r.map(function (e) {
                            return { value: "offset-lg-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "LG Offset",
                    },
                    {
                      ...
                      options: [{ value: "", name: "None" }].concat(
                        mt(
                          r.map(function (e) {
                            return { value: "offset-xl-" + e, name: e + "/12" };
                          })
                        )
                      ),
                      label: "XL Offset",
        ...
        var Ot = function (e, t) {
          e.add("container").set({
            label: "\n            "
              ...
              .concat(t, "</div>\n        "),
            category: "Layout",
            content: { type: "container", classes: ["container"] },
          });
        };
        const jt = function (e) {
          var t = e.getType("default"),
                ...
                isComponent: function (e) {
                  if (
                    ...
                    (e.classList.contains("container") ||
                      e.classList.contains("container-fluid"))
                  )
        ...
        const Pt = function (e) {
            ...
            e.addType("default", {
              model: n.extend({
                  ...
                  traits: [
                    ...
                    },
                    {
                      ...
                      options: [{ value: "", name: "Default" }].concat(
                        kt(
                          t.map(function (e) {
                            return { value: "border border-" + e, name: O(e) };
                          })
                        )
                      ),
                      label: "Border color",
                ...
                init: function () {
                  ...
                  e.bind("add", this.classesChanged.bind(this)),
                    e.bind("change", this.classesChanged.bind(this)),
                    e.bind("remove", this.classesChanged.bind(this)),
                    this.init2();
                },
                init2: function () {},
                ...
                changeType: function (e) {
                  ...
                  t.remove(this), t.add(n, { at: a }), this.destroy();
                },
              }),
              view: o,
            });
          ...
          _t = function (e) {
            var t =
              ...
              s = a.blockCategories,
              c = {
                id: { name: "id", label: a.labels.trait_id },
                for: { name: "for", label: a.labels.trait_for },
                name: { name: "name", label: a.labels.trait_name },
                placeholder: {
                  name: "placeholder",
                  label: a.labels.trait_placeholder,
                },
                value: { name: "value", label: a.labels.trait_value },
                required: {
                  type: "checkbox",
                  name: "required",
            ...
            s.media &&
              (o.image && (Ve(r, a.labels.image), qe(n)),
              o.video && (Ue(n), Re(r, a.labels.video), Ze(n))),
              s.basic &&
                (o.default && Pt(n),
                o.text && (xt(r, a.labels.text), Ct(n)),
                o.link && (Ee(r, a.labels.link), Ae(e))),
              s.layout &&
                (o.container && (Ot(r, a.labels.container), jt(n)),
                o.row && (yt(r, a.labels.row), wt(n)),
                o.column &&
                  (vt(r, a.labels.column),
                  ht(n, e),
                  pt(r, a.labels.column_break),
                  ut(n)),
                o.media_object && (ct(r, a.labels.media_object), dt(n))),
              s.components &&
                (o.alert && (it(r, a.labels.alert), lt(n)),
                o.tabs && (T(r, a), P(n, t), A(n, t), D(n, t), H(n, t)),
                o.badge && (at(r, a.labels.badge), nt(n)),
                o.card && (Ye(r, a), Ke(n, e)),
                o.collapse && (i(r, a.labels.collapse), l(e)),
                o.dropdown && (p(r, a.labels.dropdown), u(e))),
              s.typography &&
                (o.header && (We(r, a.labels.header), Xe(n)),
                o.paragraph && (Ge(r, a.labels.paragraph), $e(n))),
              s.forms &&
                (o.form && (R(r, a.labels.form), Z(n, c, t)),
                o.input &&
                  (W(r, a.labels.input),
                  X(n, c, t),
                  He(r, a.labels.file_input),
                  Fe(n, c, t)),
                o.form_group_input &&
                  (Q(r, a.labels.form_group_input), ee(n, c, t)),
                o.textarea && (oe(r, a.labels.textarea), re(n, c, t)),
                o.select && (ce(r, a.labels.select), de(e, n, c, t)),
                o.checkbox && (fe(r, a.labels.checkbox), be(n, c, t)),
                o.radio && (ye(r, a.labels.radio), we(n, c, t)),
                o.label && (Ne(r, a.labels.label), Me(n, c, t)),
                o.button_group && (ke(r, a.labels.button_group), Te(n)),
                o.button_toolbar && (Pe(r, a.labels.button_toolbar), _e(n)));
          },
          Lt = function (e) {
            var t =
                arguments.length > 1 && void 0 !== arguments[1]
            ...
            if (
              ...
              var o = e.Panels,
                r = e.Commands,
                i = o.addPanel({ id: "devices-buttons" }),
                l = i.get("buttons");
              l.add([
                {
                  id: "deviceXl",
        ...
        const Et = t().plugins.add("grapesjs-blocks-bootstrap4", function (e) {
          var t =
          ...
          var l = {
            ...
            d = Dt(
              Dt(
                {},
                {
                  blocks: Object.assign(l, n),
                  labels: Object.assign(s, o),
                  blockCategories: Object.assign(c, i),
          ...
          a(e, d), r(e, d), _t(e, d), Lt(e, d), Mt(e);
        });
      })(),
      o
    );
