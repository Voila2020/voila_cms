...
class EmailTemplatesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function getEmailBuilder(Request $request, $id)
    {
        ...
        return view('crudbooster::email_builder.templates_builder', ['id' => $id, 'email_template' => $email_template, 'button_lang' => $button_lang]);
    }
    ...
    public function getEmailBuilderContent(Request $request, $id)
    {
        ...
        if (Request::input('lang') == "en") {
            ...
            if (!$email_template->content && $id) {
                ...
                return response()->json([
                    "gjs-html" => $email_template->content ?? '<body><table id="idvv"><tbody><tr><td id="ithb"></td></tr></tbody></table></body>',
                    "gjs-styles" => $email_template->css ?? '* { box-sizing: border-box; } body {margin: 0;}*{box-sizing:border-box;}body{margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;}#idvv{height:550px;margin:0 auto 10px auto;padding:5px 5px 5px 5px;width:150%;max-width:550px;}#ithb{padding:0;margin:0;vertical-align:top;}',
                    "gjs-components" => $email_template->template ?? '[{"type":"table","droppable":["tbody","thead","tfoot"],"attributes":{"id":"idvv"},"components":[{"type":"tbody","draggable":["table"],"droppable":["tr"],"components":[{"type":"row","draggable":["thead","tbody","tfoot"],"droppable":["th","td"],"components":[{"type":"cell","draggable":["tr"],"attributes":{"id":"ithb"}}]}]}]}]',
        ...
        if (Request::input('lang') == "ar") {
            ...
            if (!$email_template->content_ar && $id) {
                ...
                return response()->json([
                    "gjs-html" => $email_template->content_ar ?? '<body><table id="idvv"><tbody><tr><td id="ithb"></td></tr></tbody></table></body>',
                    "gjs-styles" => $email_template->css_ar ?? '* { box-sizing: border-box; } body {margin: 0;}*{box-sizing:border-box;}body{margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;}#idvv{height:550px;margin:0 auto 10px auto;padding:5px 5px 5px 5px;width:150%;max-width:550px;}#ithb{padding:0;margin:0;vertical-align:top;}',
                    "gjs-components" => $email_template->template_ar ?? '[{"type":"table","droppable":["tbody","thead","tfoot"],"attributes":{"id":"idvv"},"components":[{"type":"tbody","draggable":["table"],"droppable":["tr"],"components":[{"type":"row","draggable":["thead","tbody","tfoot"],"droppable":["th","td"],"components":[{"type":"cell","draggable":["tr"],"attributes":{"id":"ithb"}}]}]}]}]',
