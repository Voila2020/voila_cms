...
require_once '../../../../../modules/common/dbConnection.php';
...
while($r = mysql_fetch_array($reslang,MYSQL_ASSOC)){
	...
	if(move_uploaded_file($tempFile,$targetFile)){
        file_put_contents('yyy', $_FILES['file']['name'].''.$info['extension']);
        $file1=$_FILES['file']['name'];
        $fileExt=$info['extension'];
       $targetPath=str_replace('../', '', $targetPath);
       $targetPath=str_replace('uploads/', '', $targetPath);
       mysql_query("INSERT INTO files (folder,file,name_$ActiveLang,ext)values('$targetPath','$file1','$file1','$fileExt')");
