...
tinymce.PluginManager.add('filemanager', function(editor) {
	...
	function filemanager (id, value, type, win) {
		...
		tinymce.activeEditor.windowManager.open({
			title: title,
			file: '../includes/tinymce/plugins/filemanager/dialog.php?type='+urltype+'&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey,
			width: 860,  
			height: 570,
			resizable: true,
			maximizable: true,
