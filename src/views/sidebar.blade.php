    ...
    <section class="sidebar">
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                @else
                    <li class="header">{{ cbLang('SUPERADMIN') }}</li>
                    @foreach (CRUDBooster::sidebarMenu()[1] as $mainMenu)
                        @if ($mainMenu->path == 'privileges')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-key'></i>
                                    <span>{{ cbLang('Privileges_Roles') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                                <ul class='treeview-menu'>
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/privileges/add*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/privileges') ? 'active' : '' }}">
                                        <a href='{{ Route('PrivilegesControllerGetIndex') }}'><i
                                                class='fa fa-bars'></i>
                                            <span>{{ cbLang('List_Privilege') }}</span></a>
                                    </li>
                                </ul>
                            </li>
                        @elseif($mainMenu->path == 'users')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-users'></i>
                                    <span>{{ cbLang('Users_Management') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                                <ul class='treeview-menu'>
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/users/add*') ? 'active' : '' }}">
                                        <a href='{{ Route('AdminCmsUsersControllerGetAdd') }}'><i
                                                class='fa fa-plus'></i>
                                            <span>{{ cbLang('add_user') }}</span></a>
                                    </li>
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/users') ? 'active' : '' }}">
                                        <a href='{{ Route('AdminCmsUsersControllerGetIndex') }}'><i
                                                class='fa fa-bars'></i>
                                            <span>{{ cbLang('List_users') }}</span></a>
                                    </li>
                                </ul>
                            </li>
                        @elseif($mainMenu->path == 'menu_management')
                            <li
                                class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/menu_management*') ? 'active' : '' }}">
                                <a href='{{ Route('MenusControllerGetIndex') }}'><i class='fa fa-bars'></i>
                                    <span>{{ cbLang('Menu_Management') }}</span></a>
                            </li>
                        @elseif($mainMenu->path == 'settings')
                            <li class="treeview">
                                <a href="#"><i class='fa fa-wrench'></i> <span>{{ cbLang('settings') }}</span>
                                    <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                                <ul class="treeview-menu">
                                    <li
                        ...
                        @elseif($mainMenu->path == 'module_generator')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-th'></i>
                                    <span>{{ cbLang('Module_Generator') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                                <ul class='treeview-menu'>
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/module_generator/step1') ? 'active' : '' }}">
                        ...
                        @elseif($mainMenu->path == 'statistic_builder')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-dashboard'></i>
                                    <span>{{ cbLang('Statistic_Builder') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                        ...
                        @elseif($mainMenu->path == 'api_generator')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-fire'></i>
                                    <span>{{ cbLang('API_Generator') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                                <ul class='treeview-menu'>
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/api_generator/generator*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/api_generator') ? 'active' : '' }}">
                                        <a href='{{ Route('ApiCustomControllerGetIndex') }}'><i
                                                class='fa fa-bars'></i>
                                            <span>{{ cbLang('list_API') }}</span></a>
                                    </li>
                                    <li
                        ...
                        @elseif($mainMenu->path == 'email_templates')
                            <li class='treeview'>
                                <a href='#'><i class='fa fa-envelope-o'></i>
                                    <span>{{ cbLang('Email_Templates') }}</span> <i
                                        class="fa fa-angle-{{ cbLang('right') }} pull-{{ cbLang('right') }}"></i></a>
                        ...
                        @elseif($mainMenu->path == 'logs')
                            <li
                                class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/logs*') ? 'active' : '' }}">
                                <a href='{{ Route('LogsControllerGetIndex') }}'><i class='fa fa-flag'></i>
                                    <span>{{ cbLang('Log_User_Access') }}</span></a>
                            </li>
                        @endif
                    @endforeach
                @endif
