    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                @if (CRUDBooster::getSetting('activate_notifications') == 'true')
                    <li class="dropdown notifications-menu">
                        ...
                        <ul id='list_notifications' class="dropdown-menu">
                            ...
                            <li class="footer"><a
                                    href="{{ route('NotificationsControllerGetIndex') }}">{{ cbLang('text_view_all_notification') }}</a>
                            </li>
                        </ul>
                    </li>
                @endif
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ cbLang('left') }}">
                                <a href="{{ route('AdminCmsUsersControllerGetProfile') }}"
                                    class="btn btn-default btn-flat"><i class='fa fa-user'></i>
                            ...
                            <div class="pull-{{ cbLang('right') }}">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    title="{{ cbLang('button_logout') }}" class="btn btn-danger btn-flat"><i
        ...
        <div class="navbar-custom-menu" style="padding: 15px">
            <a style="{{ App::getlocale() == 'en' ? '' : 'color:#fff;' }}" href="{{ Route('cb.switch_language', ['locale' => 'en']) }}">English</a>
        </div>
        <div class="navbar-custom-menu" style="margin-top: 15px">
            <a style="{{ App::getlocale() == 'en' ? 'color:#fff;' : '' }}" href="{{ Route('cb.switch_language', ['locale' => 'ar']) }}">Arabic</a>
        </div>
    </nav>
</header>
